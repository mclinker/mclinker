...
template<typename HashEntryTy, typename HashFunctionTy, typename EntryFactoryTy>
...
template<typename HashEntryTy, typename HashFunctionTy, typename EntryFactoryTy>
float HashTable<HashEntryTy,
                HashFunctionTy,
                EntryFactoryTy>::load_factor() const
{
...
void HashTable<HashEntryTy, HashFunctionTy, EntryFactoryTy>::rehash(
    typename HashTable<HashEntryTy,
                       HashFunctionTy,
                       EntryFactoryTy>::size_type pCount)
{
