...
const uint8_t hexagon_plt0[] = {
    ...
    0x1c, 0xc0, 0x49, 0x6a,  //   r28 = add (pc, ##GOT0@PCREL) } # address of
                             //   GOT0
    0x0e, 0x42, 0x9c, 0xe2,  // { r14 -= add (r28, #16)  # offset of GOTn from
                             // GOTa
...
const uint8_t hexagon_plt1[] = {
    ...
    0xc0,
    0x49,
    0x6a,  //   r14 = add (pc, ##GOTn@PCREL) } # address of GOTn
    0x1c,
    0xc0,
    0x8e,
    0x91,  // r28 = memw (r14)                 # contents of GOTn
    0x00,
    0xc0,
    0x9c,
    0x52  // jumpr r28                        # call it
};
