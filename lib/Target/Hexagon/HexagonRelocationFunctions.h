...
#define DECL_HEXAGON_APPLY_RELOC_FUNC_PTRS \
  ...
  { &unsupport,           2, "R_HEX_B15_PCREL"                   }, \
  { &unsupport,           3, "R_HEX_B7_PCREL"                    }, \
  { &unsupport,           4, "R_HEX_LO16"                        }, \
  { &unsupport,           5, "R_HEX_HI16"                        }, \
  { &unsupport,           6, "R_HEX_32"                          }, \
  { &unsupport,           7, "R_HEX_16"                          }, \
  { &unsupport,           8, "R_HEX_8"                           }, \
