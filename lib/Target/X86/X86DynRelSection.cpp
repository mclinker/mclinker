...
X86DynRelSection::X86DynRelSection(LDSection& pSection,
...
X86DynRelSection::~X86DynRelSection()
{
}

void X86DynRelSection::reserveEntry(RelocationFactory& pRelFactory,
                                    int pNum)
{
...
Relocation* X86DynRelSection::getEntry(const ResolveInfo& pSymbol,
                                       bool isForGOT,
                                       bool& pExist)
{
