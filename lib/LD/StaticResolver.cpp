...
bool StaticResolver::resolve(ResolveInfo& __restrict__ pOld,
  ...
  static const enum LinkAction link_action[LAST_ORD][LAST_ORD] = {
      /* new\old  U       w_U     d_U    wd_U   D      w_D    d_D    wd_D   C
         w_C,   Cs,    Is   */
      /* U    */ {NOACT,
                  UND,
                  UND,
      ...
      /* wd_U */ {NOACT,
                  ...
                  REFC},
      /* D    */ {
          DEF, DEF, DEF, DEF, MDEF, DEF, DEF, DEF, CDEF, CDEF, CDEF, MDEF},
      /* w_D  */ {DEFW,
                  DEFW,
                  DEFW,
                  DEFW,
      ...
      /* wd_D */ {MDEFWD,
                  ...
                  NOACT},
      /* C    */ {
          COM, COM, COM, COM, CREF, COM, COM, COM, MBIG, COM, BIG, REFC},
      /* w_C  */ {COM,
                  COM,
                  COM,
                  COM,
      ...
      /* Cs   */ {COM,
                  ...
                  REFC},
      /* Is   */ {
          IND, IND, IND, IND, MDEF, IND, IND, IND, CIND, CIND, CIND, MIND}};
