...
#line 114 "ScriptParser.h"
   ...
   enum yytokentype {
    ...
    ScriptParser (const class LinkerConfig& m_LDConfig_yyarg, class ScriptFile& m_ScriptFile_yyarg, class ScriptScanner& m_ScriptScanner_yyarg, class GroupReader& m_GroupReader_yyarg, class RpnExpr* m_pRpnExpr_yyarg, class StringList* m_pStringList_yyarg, bool m_bAsNeeded_yyarg);
  ...
  private:
    ...
    class RpnExpr* m_pRpnExpr;
    class StringList* m_pStringList;
    bool m_bAsNeeded;
  };
