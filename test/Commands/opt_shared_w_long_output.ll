...
entry:
  ...
  %2 = load float, float* %pInput.addr, align 4
  %3 = load float, float* %a_fl, align 4
  %mul4 = fmul float %3, %2
  store float %mul4, float* %a_fl, align 4
  %4 = load float, float* %a_fl, align 4
  ret float %4
}
...
entry:
  %pInput.addr = alloca float, align 4
  store float %pInput, float* %pInput.addr, align 4
  %0 = load float, float* %pInput.addr, align 4
  %conv = fpext float %0 to double
