; Check the interaction with -function-sections.
;
; When we compile the object files with `clang -ffunction-sections` or
; `llc -function-sections`, then multiple text sections will be generated.
; This test is checking:
;
; 1. The output .ARM.exidx entries are sorted.
; 2. There should be an extra EXIDX_CANTUNWIND to mark the end of the table.

; RUN: %LLC -mtriple=armv7-linux-gnueabi -filetype=obj -function-sections \
